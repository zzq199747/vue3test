    ...
    <div class="login-wrap">
      ...
      >
        ...
        <el-form-item prop="pass" class="item-form">
          <label>密码</label>
      <el-input v-model="ruleForm.pass" type="text" autocomplete="off" minlength="6" maxlength="20"></el-input>
    </el-form-item>
    <el-form-item prop="pass1" class="item-form" v-show="model === 'register'">
          <label>重复密码</label>
      <el-input v-model="ruleForm.pass1" type="text" autocomplete="off" minlength="6" maxlength="20"></el-input>
    </el-form-item>
...
<script>
import { stripscript, validateEmail, validatePass, validateVCode } from '@/untils/validate'
export default {
  name: "login",
  data() {
    ...
    const validatePasswords = (rule, value, callback) => {
      ...
      //过滤后的数据
      this.ruleForm.pass1 = stripscript(value)
    ...
    return {
      ...
      rules: {
        ...
        pass1: [{ validator: validatePasswords, trigger: "blur" }],
